...
export default function RamadanCountdown()
{
    ...
    return <div className="container mx-auto flex flex-col md:flex-row justify-center gap-10 md:gap-0 md:justify-evenly items-center">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
                {inClient? <Countdown date={new Date("04-10-2024")} renderer={renderCountdown}/> : renderCountdown({days: 0, hours: 0, minutes: 0, seconds: 0, completed: false})}
                <h1 className="text-gray-300 font-semibold">Estimate: 10/04/2024</h1>
            </div>
        </div>
}