                ...
                <div className="min-h-[80vh] flex flex-col justify-evenly items-center gap-5 w-full">
                    <div className="bg-yellow-100 border border-red-900 py-4 px-6 rounded-md w-full text-center flex flex-col gap-2">
                        ...
                        <div className="flex flex-row gap-1 text-3xl justify-center items-center">
                            <img src={"/245.webp"} alt="Aya 2:245" className="h-20"/>
                    ...
                    <div>
                        <div className="flex md:flex-row md:justify-center md:items-center flex-col gap-10 text-xl font-bold mt-10 w-full justify-start items-start">
                            <div className="flex flex-row justify-center items-center gap-2">
                                ...
                                <img className="w-full h-32 object-contain" src="/prayer-rug.png"/>
                            </div>
                            <div className="flex flex-row justify-center items-center gap-2">
                                <h1 className="font-black text-3xl m-2">2.</h1>
                                <h1 className="w-full">£50 Per Brick</h1>
                                <img className="w-full h-24 object-contain" src="/wall.png"/>
                            </div>
                            <div className="flex flex-row justify-center items-center gap-2">
                                <h1 className="font-black text-3xl m-2">3.</h1>
                                <h1 className="w-full">Long Term Loan</h1>
                                <img className="w-full h-28 object-contain" src="/loan.png"/>
                            </div>
                        </div>
                    </div>
